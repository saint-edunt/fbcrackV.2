...
echo $white"[#]> EXploitExpectedTEAM "
...
____________________________________________" | eXeteam

echo $green"Facebook crack v.2"

echo $Orange"Coded by: Mr.541NT-3DUNT"

echo "

___________________________________________" | eXeteam
...
echo $green"100 ID Cracked :"
echo $red"/sdcard/Facebook.txt"
...
echo $green"Coded By : Mr.541NT-3DUNT"

echo $green"Anda Tidak Terima?? baku hantam kyta :p"
